...
namespace Mozlite.Data.Migrations.Models
{
    ...
    public interface IMigrationRepository
    {
        ...
        Task EnsureMigrationTableExistsAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">异步取消标识。</param>
        /// <returns>返回实例列表。</returns>
        Task<Migration> FindMigrationAsync(string migrationId, CancellationToken cancellationToken = default(CancellationToken));
