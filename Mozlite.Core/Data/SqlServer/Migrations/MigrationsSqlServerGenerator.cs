...
namespace Mozlite.Data.SqlServer.Migrations
{
    ...
    public class MigrationsSqlServerGenerator : MigrationsSqlGenerator
    {
            ...
            bool terminate)
        {
            ...
            var clustered = operation.GetAnnotation<bool>(SqlServerAnnotationNames.Clustered);
        ...
        /// <param name="operation">操作实例。</param>
        /// <param name="builder"><see cref="MigrationCommandListBuilder"/>实例对象。</param>
        protected override void Generate(EnsureSchemaOperation operation, MigrationCommandListBuilder builder)
        {
            Check.NotNull(operation, nameof(operation));
            Check.NotNull(builder, nameof(builder));
            ...
            builder
                .Append("IF SCHEMA_ID(")
                .Append(SqlHelper.EscapeLiteral(operation.Name))
            ...
            MigrationCommandListBuilder builder)
        {
            ...
            if (operation.Table.Schema != null)
            {
                qualifiedName
                    .Append(operation.Table.Schema)
                    .Append(".");
            }
            qualifiedName
                .Append(operation.Table.Name)
                .Append(".")
        ...
        protected override string GenerateSqlCreate(IEntityType entityType, ITable table, object instance)
        {
        ...
        /// <param name="where">条件表达式。</param>
        /// <returns>返回生成的SQL语句。</returns>
        protected override string GenerateSqlDelete(ITable table, Expression @where)
        {
            var builder = new IndentedStringBuilder();
