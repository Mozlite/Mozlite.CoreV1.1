...
namespace Mozlite.Data
{
    ...
    public static class ExpressionExtensions
    {
        ...
        public static string[] GetPropertyNames([NotNull] this LambdaExpression propertyAccessExpression)
        {
        ...
        public static object Invoke([NotNull] this Expression expression)
        {
